...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('aryan')
        .setDescription('mangeur de merde'),
    async execute(interaction) {
        ...
        const audioPath = join(__dirname, `../../sounds/aryan${randomNum}.mp3`);
        ...
        try {
            ...
            player.on(AudioPlayerStatus.Playing, () => {
                interaction.editReply('aryan le meilleur conducteur de tuktuk <3').catch(console.error);
            });
