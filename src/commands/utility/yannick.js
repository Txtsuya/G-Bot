...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const audioPath = join(__dirname, '../../sounds/yannickkk.mp3');
        ...
        try {
            ...
            player.on(AudioPlayerStatus.Playing, () => {
                interaction.editReply('yannick le fan n°1 du bayern <3').catch(console.error);
            });
